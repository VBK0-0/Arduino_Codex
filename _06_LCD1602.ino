...
char array1[]=" Mad'bout Boards   ";                //the string to print on the LCD
char array2[]="  Hello Nerds!                ";  //the string to print on the LCD
char array3[]=" By VBK         ";                //the string to print on the LCD
